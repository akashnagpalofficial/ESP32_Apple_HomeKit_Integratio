...
[Tutorial] : https://www.youtube.com/watch?v=ux8sv7FAgjQ
...
Many thanks to [Yurik72] for providing some fine libraries for native integration and which are part of this project.
...
4. Open any sketch from the provided examples and compile. Detailed instructions on how to upload and pair with Apple Home app can be found in the [Sonoff example]
...
Your device's root page located under ``http://IPADDRESS/`` is usually configured to display sensor data, like temperature and humidity in the [Thermostat DHT]
...
- [Sonoff_basic] Sonoff basic device 
- [Sonoff_basic Web] Sonoff basic device with built-in web portal and file manager
- [Sonoff_B1] Sonoff B1 lamp, see wiki
...
Example folders contains sketch for [Advanced LED] and [Advanced dimmable LED]
...
The example folder contains the sketch [Air Quality sensor] , which implements an Air Quality Sensor within Apple Home app.
...
The example folder contains the sketch  [FAN] implements a fan within Apple Home app. You are able to control fan characteristics such as 
